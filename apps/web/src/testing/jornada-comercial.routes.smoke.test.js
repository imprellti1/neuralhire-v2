...
import { flush, setupFrontendDom, teardownFrontendDom, setHash } from './frontend-test-helpers.js';
...
test('jornada comercial routes smoke', async () => {
  ...
  assert.match(document.body.textContent, /Lista de Interesse|Entrar na Lista de Interesse/i);
