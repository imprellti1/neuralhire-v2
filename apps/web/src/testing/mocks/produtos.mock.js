...
export function createProdutosMockHandlers({ scenario = 'success' } = {}) {
  const baseHandlers = {
    ...
    'GET /produtos/p1/variacoes': () => createSuccessResponse({
      items: [
        ...
        { id: 'v2', sku: 'SKU1-02', cor: 'Azul', grade: 'M', estoque_atual: 2, preco: 12, status: 'ativo', status_comercial: 'ativo', updated_at: '2026-05-04T00:00:00.000Z' },
        { id: 'v3', sku: 'SKU1-03', cor: 'Azul', grade: 'G', estoque_atual: 2, preco: 12, status: 'ativo', status_comercial: 'ativo', updated_at: '2026-05-05T00:00:00.000Z' },
        { id: 'v4', sku: 'SKU1-04', cor: 'Azul', grade: 'GG', estoque_atual: 2, preco: 12, status: 'ativo', status_comercial: 'ativo', updated_at: '2026-05-06T00:00:00.000Z' }
      ]
    }),
