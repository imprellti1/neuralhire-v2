...
test('admin jobs page renders empty state, data, actions and errors', async () => {
  ...
  const apiClient = {
    get: async (path) => {
      ...
      if (path === '/jobs') return { items: mode === 'data' ? [{ id: 'j1', nome: 'radar_comercial_diario', status: 'ativo', locked_at: null, updated_at: '2026-06-17T10:00:00.000Z', metadata: { cadence: 'daily' }, execution_status: 'success', execution_error: null, execution_started_at: '2026-06-17T09:00:00.000Z' }, { id: 'j2', nome: 'clientes_enriquecimento_automatico', status: 'running', locked_at: '2026-06-17T10:05:00.000Z', updated_at: '2026-06-17T10:05:00.000Z', metadata: { cadence: 'adaptive' }, execution_status: 'error', execution_error: 'Falha ao criar tarefa', execution_started_at: '2026-06-17T10:05:00.000Z' }] : [] };
  ...
  assert.ok(document.body.textContent.includes('success'));
