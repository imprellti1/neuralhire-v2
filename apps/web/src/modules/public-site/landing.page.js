const styles = `
  ...
  .nh-flow-stage{background:linear-gradient(180deg,rgba(13,20,37,.98),rgba(9,15,29,.94));border:1px solid rgba(148,163,184,.16);border-radius:28px;padding:20px;box-shadow:0 18px 44px rgba(2,8,23,.18);min-width:0;width:100%}
  ...
  @media (max-width: 1180px){
    .nh-hero-grid,.nh-funnel-wrap,.nh-footer-grid,.nh-whatsapp-band{grid-template-columns:1fr}
    .nh-dashboard{max-width:100%}
    .nh-metrics-stack{grid-template-columns:repeat(2,minmax(0,1fr))}
  }
  @media (max-width: 1100px){
    .nh-kpi-grid,.nh-statbar,.nh-module-grid,.nh-grid-cards,.nh-flow-shell,.nh-card-grid-2,.nh-hero-cards{grid-template-columns:repeat(2,minmax(0,1fr))}
    .nh-metrics-stack{grid-template-columns:repeat(2,minmax(0,1fr))}
