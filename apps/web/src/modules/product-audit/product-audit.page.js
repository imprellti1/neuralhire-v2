...
function injectStyles() {
  ...
  style.id = 'nha-style';
  style.textContent = `.nha-panel{background:#fff;border:1px solid #dbe4f2;border-radius:16px;padding:14px;box-shadow:0 8px 24px rgba(16,34,68,.06)}.nha-head{display:flex;justify-content:space-between;gap:16px;align-items:flex-end;flex-wrap:wrap;margin-bottom:12px}.nha-title{font-size:30px;font-weight:700}.nha-sub{color:#61708f}.nha-grid{display:block}.nha-tools{display:grid;grid-template-columns:minmax(220px,1fr) 150px 120px 120px;gap:10px}.nha-input,.nha-btn,.nha-select{height:38px;border:1px solid #d4deee;border-radius:10px;padding:0 10px}.nha-btn{background:#1f56dc;color:#fff;border-color:#1f56dc;cursor:pointer}.nha-btn:disabled{opacity:.5;cursor:not-allowed}.nha-kpis{display:grid;grid-template-columns:repeat(8,minmax(0,1fr));gap:10px;margin-bottom:12px}.nha-kpis div{padding:10px;border:1px solid #e5ecf8;border-radius:12px;background:#fff}.nha-kpis strong{display:block;font-size:18px}.nha-table-wrap{overflow-x:hidden}.nha-table{width:100%;border-collapse:collapse;font-size:12px;table-layout:fixed}.nha-table col:nth-child(1){width:54px}.nha-table col:nth-child(2){width:23%}.nha-table col:nth-child(3){width:12%}.nha-table col:nth-child(4){width:18%}.nha-table col:nth-child(5){width:12%}.nha-table col:nth-child(6){width:11%}.nha-table col:nth-child(7){width:10%}.nha-table col:nth-child(8){width:10%}.nha-table col:nth-child(9){width:84px}.nha-table td,.nha-table th{padding:8px 8px;border-bottom:1px solid #ebf0f8;text-align:left;vertical-align:middle;overflow:hidden;text-overflow:ellipsis;white-space:nowrap}.nha-table th{font-size:11px;text-transform:uppercase;letter-spacing:.04em;color:#6b7a94}.nha-row{cursor:pointer}.nha-row:hover td{background:#f7faff}.nha-state{padding:18px;text-align:center;color:#61708f}.nha-actions{display:flex;gap:6px;align-items:center}.nha-icon-btn{display:inline-flex;align-items:center;justify-content:center;width:30px;height:30px;padding:0;border-radius:8px;background:#fff;color:#1f56dc;border:1px solid #d4deee;cursor:pointer;flex:0 0 auto}.nha-icon-btn svg{width:14px;height:14px;display:block;fill:currentColor}.nha-modal{position:fixed;inset:0;background:rgba(10,20,40,.35);display:grid;place-items:center;padding:16px}.nha-modal-card{width:min(720px,100%);background:#fff;border-radius:18px;padding:18px;max-height:90vh;overflow:auto}.nha-field{display:grid;gap:6px;margin-bottom:10px}.nha-field input,.nha-field textarea,.nha-field select{height:38px;border:1px solid #d4deee;border-radius:10px;padding:0 10px}.nha-field textarea{height:90px;padding:10px}.nha-badge{display:inline-flex;align-items:center;padding:4px 8px;border-radius:999px;background:#edf3ff;color:#1f56dc;margin:2px 4px 2px 0;max-width:100%;overflow:hidden;text-overflow:ellipsis;white-space:nowrap}.nha-badge.is-high{background:#fef2f2;color:#b91c1c}.nha-badge.is-medium{background:#fff7ed;color:#c2410c}.nha-badge.is-low{background:#eff6ff;color:#1d4ed8}.nha-summary-operational{display:flex;gap:12px;flex-wrap:wrap;align-items:center;margin-bottom:12px}.nha-summary-chip{padding:8px 12px;border-radius:999px;background:#f8fafc;border:1px solid #e5ecf8;font-weight:600}.nha-pagination{display:flex;justify-content:space-between;align-items:center;gap:12px;margin-top:12px;padding-top:12px;border-top:1px solid #ebf0f8}.nha-pagination-meta{display:flex;flex-direction:column;gap:2px;min-width:0}.nha-pagination-title{font-size:12px;font-weight:700;letter-spacing:.04em;text-transform:uppercase;color:#6b7a94}.nha-pagination-sub{font-size:13px;color:#61708f;white-space:nowrap;overflow:hidden;text-overflow:ellipsis}.nha-pagination-actions{display:flex;gap:8px;align-items:center}.nha-btn.nha-btn-secondary{background:#fff;color:#1f2937;border-color:#d4deee}.nha-btn.nha-btn-secondary:disabled{background:#f8fafc;color:#9aa6b8}.nha-ellipsis{overflow:hidden;text-overflow:ellipsis;white-space:nowrap;min-width:0;display:block}.nha-issues{display:flex;flex-wrap:wrap;gap:6px;min-width:0}.nha-issue-chip{display:inline-flex;align-items:center;max-width:100%;padding:4px 8px;border-radius:999px;font-size:11px;line-height:1.2;font-weight:700;white-space:normal;overflow:visible;word-break:break-word}.nha-issue-chip.is-high{background:#fff1f2;color:#b42318}.nha-issue-chip.is-medium{background:#fff7ed;color:#c2410c}.nha-issue-chip.is-low{background:#eff6ff;color:#1d4ed8}@media (max-width:1200px){.nha-kpis{grid-template-columns:repeat(2,minmax(0,1fr))}.nha-tools{grid-template-columns:1fr}.nha-pagination{flex-direction:column;align-items:stretch}.nha-pagination-actions{justify-content:flex-end}}`;
