...
function injectStyles() {
  ...
  style.id = 'npi2-style';
  style.textContent = `.npi2{display:grid;gap:16px}.npi2-card{background:#fff;border:1px solid #dbe4f2;border-radius:18px;padding:18px;box-shadow:0 10px 30px rgba(16,34,68,.06)}.npi2-title{font-size:30px;font-weight:800}.npi2-sub{color:#61708f;margin-top:6px}.npi2-grid{display:grid;grid-template-columns:1fr 1.1fr;gap:16px}.npi2-field{display:grid;gap:6px}.npi2-field input,.npi2-btn{height:40px;border:1px solid #d4deee;border-radius:10px;padding:0 12px}.npi2-btn{background:#1f56dc;color:#fff;font-weight:700;cursor:pointer}.npi2-btn.secondary{background:#fff;color:#1f56dc}.npi2-kpi{display:grid;grid-template-columns:repeat(5,minmax(0,1fr));gap:12px}.npi2-kpi>div{background:#f7fbff;border:1px solid #dce8fb;border-radius:14px;padding:12px}.npi2-table{width:100%;border-collapse:collapse}.npi2-table td,.npi2-table th{padding:8px;border-bottom:1px solid #edf2f8;text-align:left;font-size:13px;vertical-align:top}.npi2-table th{font-size:12px;text-transform:uppercase;letter-spacing:.04em;color:#61708f}.npi2-state{padding:18px;text-align:center;color:#61708f}.npi2-actions{display:flex;gap:8px;flex-wrap:wrap}.npi2-error{color:#b42318;background:#fef2f2;border:1px solid #fecaca;border-radius:12px;padding:10px}.npi2-note{background:#f7fbff;border:1px solid #dce8fb;border-radius:12px;padding:10px;color:#40608c}.npi2-chip{display:inline-flex;padding:4px 8px;border-radius:999px;font-size:12px;font-weight:700;background:#eef4ff;color:#2444a8}.npi2-chip.ok{background:#ecfdf3;color:#047857}.npi2-chip.warn{background:#fff7ed;color:#b45309}.npi2-chip.bad{background:#fef2f2;color:#b42318}.npi2-meta{font-size:12px;color:#61708f;margin:10px 0}@media (max-width:900px){.npi2-grid,.npi2-kpi{grid-template-columns:1fr}.npi2-title{font-size:24px}}`;
