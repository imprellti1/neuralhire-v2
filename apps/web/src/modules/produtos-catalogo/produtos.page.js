...
function injectStyles() {
  ...
  style.textContent = `
  .nhp-panel{background:#0f1b2f;border:1px solid rgba(148,163,184,.18);border-radius:16px;padding:18px;box-shadow:0 8px 24px rgba(0,0,0,.22);width:100%}
  ...
  .nhp-input,.nhp-btn{height:38px;border:1px solid rgba(148,163,184,.22);border-radius:10px;padding:0 10px;background:#0b1628;color:#e7eefb}
  .nhp-btn{background:#4f8cff;color:#fff;border-color:#4f8cff;font-weight:600;cursor:pointer}
  ...
  .nhp-table th{font-size:12px;color:#a9bbd8;text-transform:uppercase;letter-spacing:.04em;background:rgba(255,255,255,.03)}
  .nhp-table td,.nhp-table th{padding:10px;border-bottom:1px solid rgba(148,163,184,.12);text-align:left;vertical-align:middle;overflow:hidden;text-overflow:ellipsis;white-space:nowrap}
  .nhp-row-link{cursor:pointer}
  .nhp-row-link:hover{background:rgba(79,140,255,.08)}
  .nhp-row-link.is-promo-variation td{background:rgba(52,211,153,.08)}
  ...
  .nhp-badge.is-active{background:rgba(52,211,153,.16);color:#34d399}
  .nhp-badge.is-inactive{background:rgba(148,163,184,.14);color:#cbd5e1}
  .nhp-pager{display:flex;justify-content:flex-end;gap:8px;margin-top:10px}
  .nhp-pager button{height:34px;min-width:34px;border:1px solid rgba(148,163,184,.22);border-radius:8px;background:#0b1628;color:#e7eefb;cursor:pointer}
  ...
  .nhp-state{padding:24px;text-align:center;color:#91a4c4}.nhp-table-wrap{width:100%;overflow-x:hidden}
