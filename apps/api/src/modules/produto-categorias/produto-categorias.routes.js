...
import { createProdutoCategoriaHandler, deleteProdutoCategoriaHandler, getProdutoCategoria, getProdutoCategorias, updateProdutoCategoriaHandler } from './produto-categorias.controller.js';
...
export function registerProdutoCategoriasRoutes(router) {
  ...
  router.registerRoute({ method: 'DELETE', path: '/produto-categorias/:id', domain: 'produtos-catalogo', middlewares, handler: asyncHandler(async (_req, res, context) => sendSuccess(res, await deleteProdutoCategoriaHandler(context))) });
}
