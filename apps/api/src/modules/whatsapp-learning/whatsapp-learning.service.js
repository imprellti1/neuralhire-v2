...
import { executeWhatsappLearningWorker } from './whatsapp-learning.executor.js';
...
export async function runWhatsappLearningWorker(context = {}) {
  ...
  const cognitiveResult = await executeWhatsappLearningWorker({ ...context, accountId });
  return { ok: true, processed, cognitivelyProcessed: cognitiveResult.cognitivelyProcessed, failed: failed + cognitiveResult.failed, scanned: events.length + cognitiveResult.scanned, skipped: cognitiveResult.skipped };
}
