...
export function registerAiSalesRoutes(router) {
  ...
  router.registerRoute({ method: 'GET', path: '/ai-sales/insights', domain: 'ai-sales', handler: asyncHandler(async (req, res, context) => sendSuccess(res, await getAiSalesInsightsHandler(context))) });
}
